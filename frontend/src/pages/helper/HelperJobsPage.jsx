  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          ...
          <div className="flex items-center gap-2 mb-1.5">
            ...
            {job.isRequested ? (
              <span className="text-xs bg-orange-100 text-orange-700 px-2 py-0.5 rounded-full font-medium flex items-center gap-1">
                <Star className="w-3 h-3 fill-orange-500 text-orange-500" /> Yêu cầu riêng
              </span>
            ) : (
      ...
      <div className="space-y-1.5 text-sm text-gray-500 mb-4">
        ...
        {job.note && (
          <p className="flex items-start gap-2 text-gray-400 italic">
  ...
  return (
    <div className={`bg-white rounded-2xl p-5 shadow-sm border-l-4 border border-gray-100 transition-shadow hover:shadow-md ${
      ...
      {booking.status === 'in_progress' && (
        <div className="space-y-2">
          <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-3 text-center flex items-center justify-center gap-2">
            <Home className="w-4 h-4 text-indigo-600 animate-pulse" />
            <p className="text-indigo-700 text-sm font-medium">Đang thực hiện công việc...</p>
          </div>
      ...
      {booking.status === 'completed' && (
        <div className="bg-green-50 border border-green-100 rounded-xl p-3 text-center flex items-center justify-center gap-2">
